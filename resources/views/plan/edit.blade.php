@extends('layouts.app', ['title' => __('Parking Facilities')],['activePage' => 'plan'])
                    ...
                    <input type="hidden" name="product_id" value="{{$plan->product->id}}">
                               ...
                               <div class="row">
                                   ...
                                   <div class="col-3">
                                    ...
                                    <label class="form-control-label" for="interval_count">{{ __('interval_count') }}</label>
                                   ...
                                   <div class="col-6">
                                    ...
                                    <label class="form-control-label" for="interval">{{ __('Interval') }}</label>
